...
<head>
    ...
    <style>
        .aLaUne1 {
            background: linear-gradient(to top, rgba(30, 30, 32, 0.52), transparent), url('resources/images/IMG-BVEA/Groupe 260.png');
        }

        .aLaUne2 {
            background: linear-gradient(to top, rgba(30, 30, 32, 0.52), transparent), url('resources/images/IMG-BVEA/Groupe 348.png');
        }

        .aLaUne3 {
            background: linear-gradient(to top, rgba(30, 30, 32, 0.52), transparent), url('resources/images/IMG-BVEA/Groupe 321.png');
        }
    </style>
</head>
...
<body id="temoignage">
    <div class="container-fluid">
        <header class="pt-4">
            ...
            <div id="imgPanel">
                <div class="panelContent1 testimony">
                    <div class="degrade">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10">
                                    <h1 class="fontSlide">TÉMOIGNAGES</h1>
                                    <p class="titre1 text-lowercase">
                                        Bénévoles et personnes accompagnées prennent la parole pour raconter l’aventure Bien Vieillir en Afrique.


                                        <div class="yellowDivider mt-2"></div>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <main>
            <section id="aLaUne">
                <div class="container">
                    <h2 class="titre1 color2 font-weight-bold text-uppercase">actualites a la une</h2>
                    <div class="row mb-5">
                        <div class="col-md-7">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat atque, mollitia eum dolor
                                quia architecto beatae vero repellat dolorum expedita modi et necessitatibus tenetur
                                ducimus temporibus possimus voluptates aliquam deleniti.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="aLaUne1 height">
                                <h3 class="text-light font-weight-bold"><i class="fas fa-newspaper"></i>
                                    <span>NEWS</span></h3>
                                <p class="text-light font-weight-bold">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laboriosam, dolor quam
                                    dolores aut molestias, vitae voluptatem, dolorem consequuntur explicabo modi id
                                    soluta quaer
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laboriosam, dolor quam
                                    dolores aut molestias, vitae voluptatem, dolorem consequuntur explicabo modi id
                                    soluta quaer
                                ...
                                <a href="#" class="btn btn-outline-light btnOutlineNavbar">LIRE PLUS</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex flex-column justify-content-between height">
                                <div class="aLaUne2 ">
                                    <h3 class="text-light font-weight-bold"><i class="fas fa-newspaper"></i>
                                        <span>NEWS</span></h3>
                                    <p class="text-light font-weight-bold">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                                        Laboriosam, dolor quam dolores aut molestias, vitae voluptatem, dolorem
                                        consequuntur explicabo modi id soluta quaer</p>
                                    <a href="#" class="btn btn-outline-light btnOutlineNavbar">LIRE PLUS</a>
                                </div>
                                <div class="aLaUne3">
                                    <h3 class="text-light font-weight-bold"><i class="fas fa-newspaper"></i>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <h1 class="font-weight-bold text-light text-uppercase">
                                RESTEZ INFORMEE C'EST DEJA NOUS SOUTENIR ABONNEZ NOUS A LA NEWSLETTER
                            </h1>
                        </div>
                        <div class="col-md-7 d-flex align-items-center">
                            <form class="d-flex align-items-center">
                                <input type="email" name="mail" class="totalRadius"
                                    placeholder="Indiquez votre adresse e-mail">
                                <button type="submit" class="btn wBtn totalRadius">S'inscrire</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <section id="moreNews">
                <div class="container">
                    <div class="d-flex justify-content-between">
                        <h2 class="titre1 color2 font-weight-bold text-uppercase">plus d'actualites</h2>
                        <div class="d-flex align-items-center">
                            <label class="color2" for="filtre">FILTRER PAR :</label>
                            <select name="filtre" id="filtre" class="ml-4">
                                <option value="all" selected class="color2">TOUS</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="newsCard">
                                <div class="image" style="background: url('resources/images/IMG-BVEA/img09.jpg')"></div>
                                <div class="text d-flex flex-column justify-content-between">
                                    ...
                                    <a href="oneArticle.html" class="read mt-3 btn btn-outline-light">lire l'article</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="newsCard">
                                <div class="image" style="background: url('resources/images/IMG-BVEA/img-2.png')"></div>
                                <div class="text d-flex flex-column justify-content-between">
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo excepturi
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo excepturi
                    ...
                    <div class="text-center mt-4 guide">
                        <a href="#" class="color2 mr-3">DEBUT</a>
                        <a href="#" class="color2 mr-3">SUIVANT</a>
                        <a href="#" class="color2">FIN</a>
            ...
            <section id="temoignages">
                <div class="container">
                    <div class="d-flex justify-content-between align-items-end">
                        <h2 class="titre1 color2 font-weight-bold text-uppercase">consulter les temoignages</h2>
                        <h2 class="color2 font-weight-bold">CONSULTER NOS PRISES DE POSITION</h2>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="newsCard">
                    ...
                    <div class="row justify-content-around mt-5 mb-4">
                        <a href="#" class="btn blueBtn">VOIR LES TEMOIGNAGES</a>
                        <a href="#" class="btn blueBtn">VOIR NOS PRISES DE POSTITION</a>
            ...
            <section id="followUs">
                <div class="container mt5">
                    <h2 class="titre1 color2 font-weight-bold text-center">nous suivre, c'est deja nous soutenir</h2>
